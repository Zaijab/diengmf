...
class FilterExperiment(eqx.Module):
    ...
    burn_in_time: Int[Array, ""]
    total_experiment_time: Int[Array, ""]
...
# run_filter_experiment(jax.random.split(subkey, ), experiment_description)
...
num_mc_iterations = 5
keys = jax.random.split(subkey, 3 * num_mc_iterations).reshape(3, num_mc_iterations)
