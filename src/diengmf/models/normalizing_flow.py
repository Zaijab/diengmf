...
class NormalizingFlow(eqx.Module):
    ...
    def __init__(self, input_dim: int, num_layers: int, num_bins: int = 8, rqs_range_min: float = -5.0, rqs_range_max: float = 5.0, plu_use_bias: bool = True, *, key: Array):
        ...
        self.coupling_layers = [MaskedCoupling(input_dim, bijector, key=keys[i]) for i in range(num_layers)]
